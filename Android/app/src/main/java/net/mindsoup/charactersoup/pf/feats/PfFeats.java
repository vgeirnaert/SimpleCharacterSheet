...
public enum PfFeats {
	...
	TWO_WEAPON_FIGHTING, TWO_WEAPON_REND, UNSEAT, VITAL_STRIKE, WEAPON_FINESSE, WEAPON_FOCUS, WEAPON_SPECIALIZATION, WHIRLWIND_ATTACK, WIDEN_SPELL, WIND_STANCE, RAGING_VITALITY, RAGING_BRUTALITY;
