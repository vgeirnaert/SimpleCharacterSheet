...
public enum PfSkills {
	...
	KNOWLEDGE_LOCAL, KNOWLEDGE_NATURE, KNOWLEDGE_NOBILITY, KNOWLEDGE_PLANES, KNOWLEDGE_RELEIGION, LINGUISTICS, PERCEPTION, 
	...
	public static PfSkills getSkill(int i) {
		...
		case 22: return PfSkills.KNOWLEDGE_RELEIGION;
